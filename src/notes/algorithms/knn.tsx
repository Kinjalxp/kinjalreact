...
import img3 from "../../assets/knngraph1.png";
import knnBanner from "../../assets/KNNcaveman.png";
...
const KNN = () => (
  <div className="px-2 sm:px-6 lg:px-20 py-8 animate-fadeIn">
    <h1 className="text-3xl font-bold mb-2">K-Nearest Neighbors</h1>
    <p className="text-gray-500 mb-6">
      A step-by-step walkthrough of training a K-Nearest Neighbors classifier on
      the iris dataset.
    </p>
    {
      <LightboxImage
        src={knnBanner}
        alt="K-nearest neighbors overview"
    ...
    <Step
      number={20}
      title="Create and Train the KNN Model"
      description="We import the K-Nearest Neighbors (KNN) classifier, set the number of neighbors to 3, and train the model using the training data."
      code={step20}
      output={step20Output}
      // note=""
      // image={img2}
    ...
    <Step
      ...
      description="We measure the model's accuracy on the testing dataset to evaluate how well it classifies unseen flower samples. data."
      code={step21}
      output={step21Output}
      // note=""
      // image={img2}
    ...
    <Step
      ...
      description="We display the confusion matrix as a heatmap, making it easier to interpret the model's classification performance."
      code={step23}
      //output={step23Output}
      // note=""
      image={img3}
    ...
    <Step
      number={24}
      title="Generate a Classification Report"
      description="We generate a classification report containing precision, recall, F1-score, and support metrics for each flower species."
      code={step24}
      output={step24Output}
      // note=""
      //image={img3}
...
const step20 = `from sklearn.neighbors import KNeighborsClassifier
knn = KNeighborsClassifier(n_neighbors = 3)
knn.fit(X_train,y_train)`;
const step20Output = `KNeighborsClassifier(n_neighbors=3)`;

const step21 = `knn.score(X_test,y_test)`;
const step21Output = `1.0`;

const step22 = `from sklearn.metrics import confusion_matrix
y_pred = knn.predict(X_test)
cm = confusion_matrix(y_test,y_pred)
cm`;
const step22Output = `array([[11,  0,  0],
       [ 0, 10,  0],
       [ 0,  0,  9]])`;

const step23 = `%matplotlib inline
...
const step24 = `from sklearn.metrics import classification_report
print(classification_report(y_test, y_pred))`;
const step24Output = `         precision    recall  f1-score   support
